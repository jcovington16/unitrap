...
exports.TableEventBus = void 0;
const events_1 = require("events");
const from_emitter_1 = __importDefault(require("@async-generators/from-emitter"));
const receipt_js_1 = require("../validator/receipt.js");
const contract_js_1 = require("../registry/contract.js");
const index_js_1 = require("../helpers/index.js");
// @ts-expect-error Seems like this package isn't setup to work with modern esm + ts
const fromEmitter = from_emitter_1.default.default;
/**
...
class TableEventBus {
    ...
    async addListener(tableName) {
        ...
        const tableIdentifier = await (0, contract_js_1.getTableIdentifier)(tableName);
    ...
    async _getContract(chainId) {
        ...
        const { contract } = await (0, contract_js_1.getContractAndOverrides)(this.config.signer, chainId);
        this.contracts[chainId] = contract;
        return contract;
    }
    async _ensureListening(listenerId, emitter) {
        const { chainId, tableId } = await (0, contract_js_1.getTableIdentifier)(listenerId);
            ...
            const listener = (...args) => {
                ...
                const poll = async () => {
                    const baseUrl = this.config.baseUrl == null
                        ? await (0, index_js_1.extractBaseUrl)({ signer: this.config.signer })
                        : this.config.baseUrl;
                    const res = await (0, receipt_js_1.pollTransactionReceipt)({ baseUrl }, { transactionHash, chainId });
...
exports.TableEventBus = TableEventBus;
