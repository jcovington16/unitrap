import { proxies, baseURIs, } from "@tableland/evm/network.js";
 ...
 */
export const supportedChains = Object.fromEntries(mapped);
// Not exported
const supportedChainsById = Object.fromEntries(Object.values(supportedChains).map((v) => [v.chainId, v]));
/**
 ...
 */
export function getChainInfo(chainNameOrId) {
...
export function isTestnet(chainNameOrId) {
 ...
 */
export function getContractAddress(chainNameOrId) {
 ...
 */
export function getChainId(chainNameOrId) {
 ...
 */
export function getBaseUrl(chainNameOrId) {
...
export function overrideDefaults(chainNameOrId, values) {
    ...
    for (const [key, value] of Object.entries(values)) {
        if (typeof chainNameOrId === "number") {
            ...
            found[key] = value;
            supportedChains[found.chainName][key] = value;
        }
        else {
            const found = getChainInfo(chainNameOrId);
            found[key] = value;
